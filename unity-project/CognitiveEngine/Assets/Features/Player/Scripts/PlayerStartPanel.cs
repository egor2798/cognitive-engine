...
public class PlayerStartPanel : MonoBehaviour
{
    ...
    private bool initialSettingsLoaded;

    private void Start()
    {
        EnsureInitialSettingsLoaded();
    }
    ...
    private void EnsureInitialSettingsLoaded()
    {
    ...
    private void RefreshUIFromLoadedExercise()
    {
        ...
        if (speedInput != null)
            speedInput.text = loadedExercise.settings.defaultSpeed.ToString("0.###");
